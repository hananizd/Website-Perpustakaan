...
<body>
    ...
    <div class="container login-container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 login-form-1"> <!-- Menambahkan inline style untuk mengubah warna latar belakang -->
                <h3>Student Login</h3>
                <form action="login_server_page.php" method="get">
                    ...
                    <div class="form-group">
                        <input type="submit" class="btnSubmit" value="Login" />
                        <p style="color: #FFD646">Belum punya akun?<a href="registrasi.php" style="color:#fff"> Regist</a></p>
                    </div>
                </form>
            </div>
        </div>
